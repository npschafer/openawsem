...
htmlhelp_basename = 'openawsemdoc'
...
latex_documents = [
    (master_doc, 'openawsem.tex', 'OpenAWSEM Documentation',
     'openawsem', 'manual'),
]
...
man_pages = [
    (master_doc, 'openawsem', 'OpenAWSEM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'openawsem', 'OpenAWSEM Documentation',
     author, 'openawsem', 'An implementation of the AWSEM (Associative memory, Water-mediated Structure, and Energy Model) coarse-grained protein forcefield designed for use with the OpenMM simulation toolkit.',
     'Miscellaneous'),
]

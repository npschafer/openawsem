...
forceGroupTable = {"Backbone":20, "Rama":21, "Contact":22, "Fragment":23, "Membrane":24, "ER":25, "TBM_Q":26, "Beta":27, "Pap":28, "Helical":29,
                    "Q":1, "Rg":2, "Qc":3, "Non-additive Go term":4,
                    "Helix_orientation":18, "Pulling":19,
                    "Total":list(range(11, 32))+[4]
...
showEnergy = ["Non-additive Go term","Backbone", "Rama", "Contact", "Fragment", "Membrane", "ER", "TBM_Q", "Beta", "Pap", "Helical", "Total"]
showAll = showValue + showEnergy
#showValue = showAll #showing terms in kJ/mol
# , "Disulfide"
